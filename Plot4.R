...
plot(globalPower[, dateTime], globalPower[, Global_active_power], type="l", xlab="", ylab="Global Active Power")

# Plot 2

plot(globalPower[, dateTime],globalPower[, Voltage], type="l", xlab="datetime", ylab="Voltage")
...
plot(globalPower[, dateTime], globalPower[,Global_reactive_power], type="l", xlab="datetime", ylab="Global_reactive_power")
